...
public class CompareStateCountryAdvanced implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + "</div>";
        html = html + "</h1>";
        html = html + "<h5 style = 'position: relative; left: 2%; width: 600px'>Using this advanced compare form, directly compare stats and information between a state and a country</h5>";
        html = html + "</div>";
