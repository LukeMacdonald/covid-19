 ...
 */
public class CompareStateCountryAdvanced implements Handler {

    // URL of this page relative to http://localhost:7000/
    public static final String URL = "/comparestatecountryadvanced.html";
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + "</div>";
        //header
        html = html + "<div class = 'title2'>" + "<p style = 'font-size:12px;margin-top:-5px;text-align:left'><a href = '/'>Home</a> > <a href = '/comparecountries.html'>Compare Countries</a> > <a href='/comparestatecountryadvanced.html'>Compare State to Country: Advanced</a></p>";  
        html = html + "<h1>Compare State to Country";
        //button to return to simple compare page
        html = html + "<div style='display: flex; justify-content:left;'>";
        html = html + "<button onclick=\"document.location='/comparestates.html'\" style='margin-top:10px;' type='button';'>Find Similar States</button>";
        html = html + "</div>";
        
        html = html + "</h1>";
        html = html + "<h5>Using this advanced compare form, directly compare stats and information between states and countries</h5>";
        html = html + "</div>";
        ...
        html = html + " <a href='/comparestatecountryadvanced.html' style = 'background-color: rgb(241, 241, 241)'>Compare State to Country</a>";
        html = html + "</div>";
        html = html + "<div id = 'clear'></div>";

        //start of form and inputs to select country 1 and other parameters
        html = html + "<form action='/comparestatecountryadvanced.html' method='post'>";
