...
public class CompareCountries implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + "<h1>Compare Countries: Simple</h1>";
        html = html + "<h5>Using this simple compare form, find countries similar to that selected</h5>";
        html = html + "</div>";
        ...
        //creates output on page with data
            ...
            // ArrayList<Float> similarDeathRate = jdbc.getSimilarDeathRate(country_drop);
            ArrayList<String> highestDeathDay = jdbc.highestDeathDay(country_drop);
                ...
                html = html + "<div id='div1'>";
                    ...
                    html = html + "<p>Similar Mortality Rate: </p>";
                    
                    // for (int i=0; i < similarDeathRate.size(); ++i){
