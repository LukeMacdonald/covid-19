...
public class CompareCountries implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + "<button onclick=\"document.location='/comparecountriesadvanced.html'\" style='margin-top:10px;font-size:16px;'; type='button'; >Compare 2 Countries</button>";
        html = html + "</div>";
        html = html + "</h1>";
        ...
        //Form
        html = html + "<form class = action='/comparecountries.html' method='post'>";
